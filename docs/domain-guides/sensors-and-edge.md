# Sensors and Edge Systems

This guide names public acceptance-boundary questions for sensors and edge systems. It is not a deployment guide or certification profile.

## Representative high-consequence actions

- camera event admission
- voice command capture
- RF/GNSS location update
